...
public class CourseValidation implements Validations<Course> {
    ...
    private static final List<String> MANDATORY_FIELDS = List.of("course_code", "course_name", "course_section","professor_id","term");
    private static final List<String> EXPECTED_FIELDS_ORDER = List.of("course_code", "course_name","course_section" ,"professor_id", "term");
